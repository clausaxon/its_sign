...
<head>
    ...
    <style>
                            ...
                            <div class="card" style="width:400px; text-align:center;">
                                <!-- <img class="card-img-top" src="{{ URL::to('/storage/public/pngfolder/' . $signature->signature)}}" alt="Card image" style="width:100%"> -->
                                <div class="card-body">
                                ...
                                <p class="card-text">Updated : {{$signature->updated_at}} UTC</p>
